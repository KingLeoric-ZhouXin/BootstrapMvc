...
namespace Model
{
    ...
    public partial class RM_DBEntities : DbContext
    {
        public RM_DBEntities()
            : base("name=RM_DBEntities")
        {
        }
        ...
        public virtual DbSet<Base_O_A_Setup> Base_O_A_Setup { get; set; }
        ...
        public virtual DbSet<Base_UserGroupRight> Base_UserGroupRight { get; set; }
